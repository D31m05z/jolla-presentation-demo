...
CC            = gcc
CXX           = g++
DEFINES       = -DDEPLOYMENT_PATH="\""/usr/share/SmartDevCon/"\"" -DQT_QML_DEBUG -DQT_DECLARATIVE_DEBUG -DQT_QUICK_LIB -DQT_QML_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -m32 -march=core2 -mssse3 -mtune=atom -mfpmath=sse -fasynchronous-unwind-tables -fno-omit-frame-pointer -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -pipe -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -m32 -march=core2 -mssse3 -mtune=atom -mfpmath=sse -fasynchronous-unwind-tables -fno-omit-frame-pointer -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++ -I. -Isailfishapplication -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -Imoc
LINK          = g++
LFLAGS        = 
...
Makefile: SmartDevCon.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/SmartDevCon1.0.0 || mkdir -p obj/SmartDevCon1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/SmartDevCon1.0.0/ && $(COPY_FILE) --parents sailfishapplication/sailfishapplication.h obj/SmartDevCon1.0.0/ && $(COPY_FILE) --parents main.cpp sailfishapplication/sailfishapplication.cpp obj/SmartDevCon1.0.0/ && (cd `dirname obj/SmartDevCon1.0.0` && $(TAR) SmartDevCon1.0.0.tar SmartDevCon1.0.0 && $(COMPRESS) SmartDevCon1.0.0.tar) && $(MOVE) `dirname obj/SmartDevCon1.0.0`/SmartDevCon1.0.0.tar.gz . && $(DEL_FILE) -r obj/SmartDevCon1.0.0
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/SmartDevCon || mkdir -p $(INSTALL_ROOT)/usr/share/SmartDevCon
	-$(INSTALL_PROGRAM) /home/mersdk/Sailfish/SmartDevCon/main.qml $(INSTALL_ROOT)/usr/share/SmartDevCon/
	-$(INSTALL_DIR) /home/mersdk/Sailfish/SmartDevCon/pages $(INSTALL_ROOT)/usr/share/SmartDevCon/
	-$(INSTALL_DIR) /home/mersdk/Sailfish/SmartDevCon/cover $(INSTALL_ROOT)/usr/share/SmartDevCon/
	-$(INSTALL_PROGRAM) /home/mersdk/Sailfish/SmartDevCon/main.qml $(INSTALL_ROOT)/usr/share/SmartDevCon/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SmartDevCon/main.qml
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SmartDevCon/cover
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SmartDevCon/pages
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/SmartDevCon/main.qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/SmartDevCon/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/Sailfish/SmartDevCon/SmartDevCon.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/SmartDevCon.desktop
